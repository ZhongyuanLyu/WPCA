...
set.seed(seed)
dist_mat <- simulate_loading_distribution(N = 200L, Times = 200L, rho = 0.6, gamma = 0, N_rep = n_rep)
...
file_qq <- file.path(fig_dir, "sim_inf_L_N200_T200.png")
file_hist <- file.path(fig_dir, "sim_inf_L_N200_T200_hist.png")
summary_file <- file.path(table_dir, "Figure3_loading_error_summary.csv")
