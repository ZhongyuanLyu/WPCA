...
set.seed(seed)
dist_mat <- simulate_factor_distribution(N = 100L, Times = 100L, rho = 0.6, gamma = 0, N_rep = n_rep)
...
file_qq <- file.path(fig_dir, "sim_inf_N100_T100.png")
file_hist <- file.path(fig_dir, "sim_inf_N100_T100_hist.png")
summary_file <- file.path(table_dir, "Figure5_factor_error_summary.csv")
